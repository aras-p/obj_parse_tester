    ...
    while (fin)
    {
        ...
        else if (strlen(line)>0)
        {
            ...
            else if (material)
            {
                ...
                {
                    std::cerr <<"*** line not handled *** :"<<line<<std::endl;
                }
            }
            else
            {
...
bool Model::readOBJ(std::istream& fin, const std::string& baseDir)
{
    ...
    while (fin)
    {
        ...
        else if (strlen(line)>0)
        {
            ...
            else if (strncmp(line,"mtllib ",7)==0)
            {
                ...
                std::string fullPathFileName = baseDir + "/" + materialFileName;
                if (!fullPathFileName.empty())
                {
                    ...
                    {
                        std::cerr << "Obj unable to load mtllib '" << fullPathFileName << "'\n";
                    }
                }
                else
                {
                    std::cerr << "Obj unable to find mtllib '" << materialFileName << "'\n";
                }
            }
            ...
            else if (strncmp(line,"s ",2)==0)
            {
                ...
                else
                {
                    ...
                    if (result!=1)
                    {
                        std::cerr << "*** error reading smoothing group ***" << std::endl;
                    }
                }
